        ...
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
             ...
             <button type="button" class="btn btn-primary m-auto float-right mt-3" data-bs-toggle="modal" data-bs-target="#newTransaction"><i class="fas fa-money-bill-wave"></i> Create Transaction</button>

              <h5 class="card-title">Transactions <span>| Today</span></h5>

              <div class="table-responsive">
                <table id="attendanceTbl" class="table table-bordered table-sm" width="100%">
